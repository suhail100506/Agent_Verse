...
export const AGENT_LIBRARY = [
  {
    ...
    icon: '🧠',
    description: 'Classifies user intent and dispatches to the right specialized sub-agent.',
    defaultSystemPrompt: 'You are the master orchestrator for a cybersecurity multi-agent platform. Classify the incoming request and route it to the correct specialist agent, then synthesize their findings into a concise executive summary.',
    defaultModel: 'llama-3.3-70b-versatile',
  },
  {
    id: 'agent-doc-ext',
    name: 'Fake Certificate Verification Agent',
    icon: '🤖',
...
Respond with ONLY a JSON object: {"status": "Safe"|"Suspicious"|"Fake", "risk_level": "...", "overall_score": <int>, "confidence": <float>, "checks": {...}, "summary": "...", "recommendation": "...", "next_action": "..."}`,
  ...
  },
  {
    ...
    icon: '🌐',
    description: 'IP/domain reputation, abuse confidence scoring, threat category classification.',
    defaultSystemPrompt: `You are a cyber threat intelligence analyst evaluating an IP address, domain, or URL.
...
Respond with ONLY a JSON object: {"status": "Verified"|"Suspicious"|"Fake", "risk_level": "...", "overall_score": <int>, "confidence": <float>, "checks": {...}, "summary": "...", "recommendation": "...", "next_action": "..."}`,
  ...
  },
  {
    ...
    icon: '🎭',
    description: 'Detects manipulation tactics (urgency, impersonation, financial requests) and deepfake indicators.',
    defaultSystemPrompt: `You are a social engineering and deepfake detection expert reviewing text content and optional media metadata
for manipulation tactics (urgency/pressure, authority impersonation, financial requests) or media tampering.
Respond with ONLY a JSON object: {"status": "Verified"|"Suspicious"|"Fake", "risk_level": "...", "overall_score": <int>, "confidence": <float>, "checks": {...}, "summary": "...", "recommendation": "...", "next_action": "..."}`,
    defaultModel: 'llama-3.3-70b-versatile',
  },
];
